...
Dispatch taskplex:code-reviewer subagent to catch issues before they cascade.
...
Use Task tool with taskplex:code-reviewer type, fill template at `code-reviewer.md`
...
[Dispatch taskplex:code-reviewer subagent]
