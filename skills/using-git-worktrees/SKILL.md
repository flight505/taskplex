...
2. ~/.config/taskplex/worktrees/<project-name>/ (global location)
...
### For Global Directory (~/.config/taskplex/worktrees)
...
case $LOCATION in
  .worktrees|worktrees)
    ...
    ;;
  ~/.config/taskplex/worktrees/*)
    path="~/.config/taskplex/worktrees/$project/$BRANCH_NAME"
    ;;
esac
